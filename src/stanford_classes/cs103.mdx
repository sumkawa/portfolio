...
CS 103 was a very cool class, even if the stuff covered wasn't the most useful stuff for day to day programming. Something that made a huge different was taking it with Sean Szumlanski and Keith Schwarz, both of whom are fantastic, wonderful lecturers.
